...
import 'package:ePaunaLite/controller/ProfilePic/serviceProviderProfileModel.dart';
...
class CRUDPage extends StatefulWidget {
  List notification;
  String hotelName;
  CRUDPage({super.key, required this.notification, required this.hotelName});
  ...
  AcceptOffer(String customerIdValue, String rate, int index) async {
    ...
    var data = {
      ...
      'data': {
        ...
        "sid": sidValue,
        "logo":
            "https://pauna.tukisoft.com.np/ServiceProviderProfile/$ServiceProviderLogo"
      }
    };
    print(data);
                    ...
                    : SingleChildScrollView(
                        child: SizedBox(
                          height: notifications.length <= 3
                              ? notifications.length * Get.height * 0.25
                              : Get.height - 200,
                          child: NotificationListener<ScrollNotification>(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return notifications[index]['hourlyBargain']
                                              ?.toString() ==
                                          "true"
                                      ? Stack(
                                          children: [
                                                      ...
                                                      Expanded(
                                                        ...
                                                        child: CounterOffer2(
                                                          ...
                                                          Checked_out: notifications[
                                                                  ...
                                                                  ?.toString() ??
                                                              'N/A',
                                                          roomquantity: notifications[
                                                                          index]
                                                                      [
                                                                      'bedQuantity']
                                                                  ?.toString() ??
                                                              'N/A',
                                                          noofguest: notifications[
                                                                          index]
                                                                      [
                                                                      'personCount']
                                                                  ?.toString() ??
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              AcceptDecline(
                                                                onpressed: () {
                                                                  _deleteItem(notifications[
                                                                          index]
                                                                      [
                                                                      'id']); // deleteRequest(index);
                                                                },
                                                                bgcolor:
                                                                    PrimaryColors
                                                                        .primaryred,
                                                              ...
                                                              AcceptDecline(
                                                                onpressed: () {
                                                                  String
                                                                      customerId =
                                                                      notifications[index]['customerPlayerId']
                                                                              ?.toString() ??
                                                                          'N/A';
                                                                  showDialog(
                                                                    context:
    ...
    scrollabel
        ? _scrollController.animateTo(
            _scrollController.position.maxScrollExtent +
                200, // Scroll to the top (position 0)
...
String obscurePhoneNumbers(String text) {
  ...
  return text.replaceAllMapped(phoneRegex, (match) {
    ...
    return '*' *
        phoneNumber!.length; // Replace with asterisks of the same length
  });
}
