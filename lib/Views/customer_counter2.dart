...
class _CustomerCounter2State extends State<CustomerCounter2> 
                ...
                ? Container(
                        ...
                        child: ListView(
                          ...
                          SingleChildScrollView(
                            child: Container(
                              height:notifications.length <= 3  ? notifications.length *200 : Get.height-200,
                              child: ListView.builder(
                                itemCount: notifications.length,
                                shrinkWrap: true,
                                reverse: true,
                                itemBuilder: (context, index) {
                                   final reversedIndex = notifications.length - 1 - index; // Reverse the index
                                            ...
                                            Expanded(
                                              ...
                                              child: CounterOffer(
                                                ...
                                                amount: notification['rate']
                                                        ?.toString() ??
                                                    'N/A',
                                                Checked_in: notification['startDate']
                                                        ?.toString() ??
                                                    'N/A',
                                                Checked_out: notification['endDate']
                                                        ?.toString() ??
                                                    'N/A',
                                                roomquantity: notification['bedQuantity']
                                                        ?.toString() ??
                                                    'N/A',
                                                noofguest: notification['personCount']
                                                        ?.toString() ??
                                                    'N/A',
                                                distance: notification['distance']
                                                        ?.toString() ??
                                                    'N/A',
                                                customerPlayerId: notification['customerPlayerId']
                                                        ?.toString() ??
                                                    'N/A',
                                              ),
                                            ),
              ...
              Expanded(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Image.asset('assets/hourly_booking.png'):
                    Text(
                      "Rs." + widget.amount,
                      style: const TextStyle(
                        fontSize: 16,
