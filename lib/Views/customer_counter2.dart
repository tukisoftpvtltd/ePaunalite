...
import 'package:ePaunaLite/Views/components/CustomeDrawer.dart';
...
class CustomerCounter2 extends StatefulWidget {
  ...
  String hotelName;
  CustomerCounter2(
      {super.key, required this.notification, required this.hotelName});
                          ...
                          child: Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                final reversedIndex = notifications.length -
                                    1 -
                                            ...
                                            child: CounterOffer(
                                              ...
                                              Checked_out:
                                                  notification['endDate']
                                                      ...
                                                      'N/A',
                                              roomquantity:
                                                  notification['bedQuantity']
                                                          ?.toString() ??
                                                      'N/A',
                                              noofguest:
                                                  notification['personCount']
                                                          ?.toString() ??
                                                      'N/A',
                                              distance: notification['distance']
                                                      ?.toString() ??
                                                  'N/A',
                                              customerPlayerId: notification[
                                                          'customerPlayerId']
                                                      ?.toString() ??
                                                  'N/A',
                                            ),
